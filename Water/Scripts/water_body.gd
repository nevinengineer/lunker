...
onready var water_spring = preload("res://Water/Scenes/WaterSpring.tscn")

#the body of water depth
export var depth = 10000
var target_height = 0
...
onready var splash_particle = preload("res://Water/Scenes/SplashParticles.tscn")
